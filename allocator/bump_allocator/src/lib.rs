...
/// Naive implementation of a heap allocator
/// Allocation is simple but de-allocation does not exist
impl BumpAllocator {
...
/// We never allocate more memory than requested
#[no_mangle]
pub extern fn __rust_usable_size(size: usize, _align: usize) -> usize {
    size
}

/// To keep things simple, __rust_reallocate_inplace isn't supported
/// Always return the old size
#[no_mangle]
...
/// Copy contents of old allocation to new allocation
#[no_mangle]
