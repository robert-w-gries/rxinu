...
#[cfg(target_arch = "x86")]
use x86::bits32::segmentation::{self, SegmentDescriptor, SegmentSelector};

#[cfg(target_arch = "x86_64")]
use x86::bits64::task::TaskStateSegment;
#[cfg(target_arch = "x86_64")]
use x86::bits64::segmentation::{self, SegmentBitness, SegmentDescriptor, SegmentSelector};
...
pub unsafe fn init(tss: &TaskStateSegment) {
    ...
    GDT[GDT_KERNEL_CODE] =
        SegmentDescriptor::new_memory(0, 0, Type::Code(CODE_READ), false, PrivilegeLevel::Ring0);

    GDT[GDT_KERNEL_DATA] =
        SegmentDescriptor::new_memory(0, 0, Type::Data(DATA_WRITE), false, PrivilegeLevel::Ring0);
...
pub unsafe fn init(tss: &TaskStateSegment) {
    // TODO: Investigate PrivilegeLevel for TSS
    // Kernel code
    GDT[GDT_KERNEL_CODE] = SegmentDescriptor::new_memory(
        0,
        0,
        Type::Code(CODE_READ),
        false,
    ...
    // Kernel data
    GDT[GDT_KERNEL_DATA] = SegmentDescriptor::new_memory(
        0,
        0,
